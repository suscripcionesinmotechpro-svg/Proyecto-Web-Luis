...
(function () {
  ...
  var NAV_HTML = [
    ...
    '        <img src="' + BP + 'assets/images/logo.png" alt="Bajar Peso Clinic Logo" style="height: 64px; width: auto; object-fit: contain;">',
    '      </a>',
    '      <div class="nav-links" role="list">',
    '        <a href="' + BP + 'index.html" class="nav-link" data-i18n="nav.home">Inicio</a>',
    ...
    '              <a href="' + BP + 'pages/tratamiento-mounjaro.html" class="dropdown-item"><div class="dropdown-item-icon"><img src="' + BP + 'assets/images/mounjaro.png" alt="Mounjaro"></div><div class="dropdown-item-text"><div class="dropdown-item-name" data-i18n="treatments.mounjaro_title">Mounjaro</div><div class="dropdown-item-desc" data-i18n="nav.mounjaro_desc">Control efectivo del peso.</div></div><span class="dropdown-arrow-sm">↗</span></a>',
    '              <a href="' + BP + 'pages/tratamiento-wegovy.html"   class="dropdown-item"><div class="dropdown-item-icon"><img src="' + BP + 'assets/images/wegovy.png" alt="Wegovy"></div><div class="dropdown-item-text"><div class="dropdown-item-name" data-i18n="treatments.wegovy_title">Wegovy</div><div class="dropdown-item-desc" data-i18n="nav.wegovy_desc">Te ayuda a sentirte saciado.</div></div><span class="dropdown-arrow-sm">↗</span></a>',
    '              <a href="' + BP + 'pages/tratamiento-ozempic.html"  class="dropdown-item"><div class="dropdown-item-icon"><img src="' + BP + 'assets/images/ozempic.png" alt="Ozempic"></div><div class="dropdown-item-text"><div class="dropdown-item-name" data-i18n="treatments.ozempic_title">Ozempic</div><div class="dropdown-item-desc" data-i18n="nav.ozempic_desc">Mejora el control glucémico.</div></div><span class="dropdown-arrow-sm">↗</span></a>',
    '              <a href="' + BP + 'pages/tratamiento-saxenda.html"  class="dropdown-item"><div class="dropdown-item-icon"><img src="' + BP + 'assets/images/saxenda.png" alt="Saxenda"></div><div class="dropdown-item-text"><div class="dropdown-item-name" data-i18n="treatments.saxenda_title">Saxenda</div><div class="dropdown-item-desc" data-i18n="nav.saxenda_desc">Controla el apetito.</div></div><span class="dropdown-arrow-sm">↗</span></a>',
    '            </div>',
    '          </div>',
    '        </div>',
    '        <div class="nav-dropdown nav-link">',
  ...
  var MOB_HTML = [
    ...
    '  <nav>',
    '    <a href="' + BP + 'index.html" class="mobile-nav-link" data-i18n="nav.home">Inicio</a>',
    ...
    '      <a href="' + BP + 'pages/tratamiento-mounjaro.html" class="mobile-sub-link"><img src="' + BP + 'assets/images/mounjaro.png" alt="Mounjaro" style="width:24px; height:24px; object-fit:cover; border-radius:4px; margin-right:8px;"> Mounjaro</a>',
    '      <a href="' + BP + 'pages/tratamiento-wegovy.html"   class="mobile-sub-link"><img src="' + BP + 'assets/images/wegovy.png" alt="Wegovy" style="width:24px; height:24px; object-fit:cover; border-radius:4px; margin-right:8px;"> Wegovy</a>',
    '      <a href="' + BP + 'pages/tratamiento-ozempic.html"  class="mobile-sub-link"><img src="' + BP + 'assets/images/ozempic.png" alt="Ozempic" style="width:24px; height:24px; object-fit:cover; border-radius:4px; margin-right:8px;"> Ozempic</a>',
    '      <a href="' + BP + 'pages/tratamiento-saxenda.html"  class="mobile-sub-link"><img src="' + BP + 'assets/images/saxenda.png" alt="Saxenda" style="width:24px; height:24px; object-fit:cover; border-radius:4px; margin-right:8px;"> Saxenda</a>',
    '    </div>',
