...
(function () {
  ...
  var NAV_HTML = [
    ...
    '        <a href="' + BP + 'pages/tratamientos.html" class="nav-link" data-i18n="nav.treatments">Tratamientos</a>',
  ...
  var MOB_HTML = [
    ...
    '    <a href="' + BP + 'pages/tratamientos.html" class="mobile-nav-link" data-i18n="nav.treatments">Tratamientos</a>',
