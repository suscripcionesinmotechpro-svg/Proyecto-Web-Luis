...
(function () {
  ...
  var NAV_HTML = [
    ...
    '        <svg class="logo-icon" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">',
    '          <path d="M28 10.5C25.6 8.1 20.5 8.3 19 11.5C18 13.6 19 15.9 17.4 18.2C15.4 21.2 10.2 21.8 7.7 19.2C5 16.5 7.1 13.4 4.4 10.6C0 6.2 -7 12 -3.5 17.8C-1 21.8 3.5 18.7 6.1 22.5C7.4 24.4 6.7 26.3 7.5 28.4C9 32.4 15.3 32.8 17.5 28.8C18.8 26.5 17.5 23.7 19.9 21.5C22 19.5 24.6 20.5 26.8 19.4C30 17.8 30.7 13.1 28 10.5Z" fill="currentColor" transform="translate(12,0) scale(0.75)"/>',
    '          <circle cx="20" cy="5" r="4.5" fill="currentColor"/>',
    '        </svg>',
    '        <div><div class="logo-text">Bajar Peso</div><div class="logo-sub">bajarpeso.es</div></div>',
    '      </a>',
  ...
  var FOOT_HTML = [
    ...
    '          <svg width="32" height="32" viewBox="0 0 40 40" fill="none"><path d="M28 10.5C25.6 8.1 20.5 8.3 19 11.5C18 13.6 19 15.9 17.4 18.2C15.4 21.2 10.2 21.8 7.7 19.2C5 16.5 7.1 13.4 4.4 10.6C0 6.2 -7 12 -3.5 17.8C-1 21.8 3.5 18.7 6.1 22.5C7.4 24.4 6.7 26.3 7.5 28.4C9 32.4 15.3 32.8 17.5 28.8C18.8 26.5 17.5 23.7 19.9 21.5C22 19.5 24.6 20.5 26.8 19.4C30 17.8 30.7 13.1 28 10.5Z" fill="currentColor" transform="translate(12,0) scale(0.75)"/><circle cx="20" cy="5" r="4.5" fill="currentColor"/></svg>',
    '          <div><div class="logo-text" style="font-size:1.1rem">Bajar Peso</div></div>',
    '        </a>',
